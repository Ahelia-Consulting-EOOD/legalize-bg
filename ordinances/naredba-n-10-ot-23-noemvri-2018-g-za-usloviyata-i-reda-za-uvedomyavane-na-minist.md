...
*** В случай че на който и да е от въпросите в секция "Изключения от режима по държавните помощи" отговорът е "ДА", то и крайният отговор за секцията е "ДА" и мярката може да бъде "непомощ".
