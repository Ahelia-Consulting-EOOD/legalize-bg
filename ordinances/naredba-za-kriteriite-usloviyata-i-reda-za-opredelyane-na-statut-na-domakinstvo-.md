...
Най-високият консервативен Егод
...
(4) Всеки достъп до данни в Информационната система се придружава от автоматичен запис в системни дневници за лицето, което е извършило обработката или е достъпило данните, за времето на извършването и (във формат - дата, час, минута и секунда) и за вида на извършената обработка.
...
9. запазва информацията по чл. 22, т. 1 и 2 при първоначалното и вписване и след обработването и с данните, получени по т. 1 - 8;
