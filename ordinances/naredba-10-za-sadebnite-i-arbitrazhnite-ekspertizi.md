...
(3) Когато няма съответен специалист при държавно учреждение, ведомства, народни съвети, обществени организации или научни институти, органът който назначава експертизата, може да възложи извършването й на частно лице-експерт освен ако съответният закон забранява назначаването на частни лица.
...
1. трите имена, домашният адрес на експерта, наименованието и адресът на учреждението, организацията или научния институт, където работи;
...
1. което е съпруг, роднина по права линия, по съребрена линия до четвърта степен и по сватовство от първа степен на страните по делото или длъжностното лице, което е назначило експертизата;
