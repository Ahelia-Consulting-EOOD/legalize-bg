...
(2) Новосъздадените и преобразуваните търговски дружества, както и дружествата по ал. 1 и такива, които разширяват дейността си в изпълнение на международни проекти, до набиране на базисен период от четири последователни тримесечия ползват само добавената стойност на един зает от отчетното и предходното тримесечие. В случаите на намаление на добавената стойност средствата за работна заплата не се намаляват.
