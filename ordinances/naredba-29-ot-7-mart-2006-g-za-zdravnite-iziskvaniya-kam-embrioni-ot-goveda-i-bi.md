...
Ембриони от домашни ЕПЖ

I.1. Изпращач на стоката
...
I.23. Идентификация на контейнерите/номер на пломбата
...
I.26. Транзит през трета страна 0

I.27. Транзит през държави членки 0
