...
**Чл. 36.** (1) Агенцията по вписванията предоставя чрез регистриран отдалечен достъп справки по лице, имот, партида и справка за съдържанието на акт (документ) и реквизитите, с които е вписан, изпълнявани чрез информационната и система.
