...
(2) (Доп. - ДВ, бр. 53 от 2018 г.) Лицата, които представляват организациите по ал. 1, подават заявление по образец (приложение № 1) до главния директор на ГД "ГВА" с посочен единен идентификационен код (ЕИК) или код по БУЛСТАТ, към което прилагат:
...
10. данни за човешките ресурси в съответствие с изискванията на т. 5 от Приложение І от Регламент (ЕС) № 1035/2011;
...
17. годишен доклад за извършваната дейност в съответствие с т. 9 от Приложение І от Регламент (ЕС) № 1035/2011, освен когато заявителят за получаване на СИАНО не е извършвал дейност по предоставяне на АНО;
...
(3) Отказът за изменение на СИАНО по ал. 2 подлежи на обжалване по реда на Административнопроцесуалния кодекс.
...
(2) Програмата по ал. 1 и обхватът на включените в нея инспекции могат да се променят при възникване на необходимост. Доставчиците на аеронавигационно обслужване се уведомяват за промяната в срок до 10 дни след утвърждаването и.
...
(2) Копие от доклада се връчва на ДАНО, а оригиналът се прилага към служебното му дело по чл. 4, ал. 2.
...
**Чл. 29.** (1) В случаите, когато във функционална система е открито състояние, което е в разрез с изискванията за безопасност и което налага незабавни действия, главният директор на ГД "ГВА" или оправомощено от него лице издава указание по безопасност съгласно приложение № 3, което подлежи на незабавно изпълнение след внасянето му в деловодството на ДАНО или след връчването му на съответните длъжностни лица на ДАНО.

(2) Указанието по безопасност по ал. 1 съдържа най-малко информацията по чл. 13, пар. 2 от Регламент (ЕС) № 1034/2011.
...
(2) Одобрението на процедурите за извършване на промените се извършва по реда на чл. 13 и при извършване на необходимите инспекции по раздел VІ.
...
Заявление за първоначално издаване на свидетелството 0
