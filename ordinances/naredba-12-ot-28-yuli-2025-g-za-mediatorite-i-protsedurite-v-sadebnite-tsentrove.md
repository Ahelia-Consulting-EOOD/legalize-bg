...
**Чл. 43.** (1) Координаторът незабавно уведомява медиатора за информационната среща за процедурата по медиация, за участието в която е определен, като му съобщава времето и мястото за провеждането и, страните и техните представители, както и предмета на спора.
...
(2) Всяка страна може да поиска отлагане на насрочената среща само веднъж в рамките на срока за провеждането и.
...
(3) За провеждане на процедурата по медиация страните заплащат такса в размера, посочен в приложение № 1, като прилагат доказателства за заплащането и към заявлението по ал. 2. Когато такива доказателства не са представени, координаторът съобщава на страните да ги представят в тридневен срок от уведомяването.
