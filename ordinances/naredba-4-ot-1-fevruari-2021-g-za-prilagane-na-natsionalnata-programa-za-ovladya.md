...
(3) До 1 март на годината, следваща преброяването, протоколът по ал. 2 се изпраща в съответната областна дирекция по безопасност на храните (ОДБХ), която обобщава данните от протоколите на всички общини на територията на областта и изпраща информацията на Българската агенция по безопасност на храните (БАБХ) в 3-дневен срок от изготвянето и.
