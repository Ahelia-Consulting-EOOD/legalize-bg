...
Сержант (Старшина за Военноморските сили) - киберсигурност и
...
В компютърните зали се провеждат практически занятия по специалността. Те следва да разполагат с персонален компютър на всеки обучаван с необходимия специфичен хардуер и софтуер, а също и инсталирани в мрежа принтер и скенер, мултимедиен проектор и достъп до интернет.
