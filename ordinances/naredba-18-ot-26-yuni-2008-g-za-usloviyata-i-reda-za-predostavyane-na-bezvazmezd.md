...
1. Не е получило минимална помощ по реда на Регламент (ЕО) № 1998/2006
...
Инвестициите са предназначени за:
...
8.9. Среден списъчен брой(3) на наетите лица по трудово и служебно правоотношение и временна заетост
...
А 0 Микропредприятие

В 0 Малко предприятие

С 0 Средно предприятие
