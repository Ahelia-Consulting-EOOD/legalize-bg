...
(2) В бояджийските помещения и складове за бояджийски материали, както и в помещенията за ремонт и регулиране на горивна апаратура, е забранено храненето и съхраняването на хранителни продукти и питейна вода. Източниците на питейна вода се разполагат извън тези помещения.
