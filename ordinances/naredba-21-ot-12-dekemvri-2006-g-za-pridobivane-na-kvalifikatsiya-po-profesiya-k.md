...
Квалификационна подготовка по "Усъвършенстване изпълнението задълженията на вахтен и дежурен помощник-капитан" по програма, утвърдена от ИАМА.
