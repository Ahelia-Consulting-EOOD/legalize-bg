...
(2) Еднократният или временният характер на упражняването на професията подлежи на преценка за всеки конкретен случай по отношение на срока, честотата, редовността и непрекъснатостта на предоставянето и.
...
2. удостоверение, издадено от компетентния орган на съответната държава членка, че заявителят е законно установен на територията и с цел упражняване на професията "Планински водач", както и че към момента на издаване на удостоверението не му е наложена забрана, включително временна, за упражняване на професията;
