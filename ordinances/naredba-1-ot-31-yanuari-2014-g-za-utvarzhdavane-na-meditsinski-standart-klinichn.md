...
13.1.1. (доп. - ДВ, бр. 15 от 2025 г.) изследване на урина: pH, специфично тегло, полуколичествено изследване на белтък, глюкоза, кетонни тела, уробилиноген, билирубин, кръв и ориентировъчно изследване на "седимент"; микроалбуминурия; определяне на албумин - креатининово отношение в урината (UACR); тест за бременност;
...
13.1.4. (доп. - ДВ, бр. 15 от 2025 г.) клинично-химични изследвания: глюкоза, хемоглобин А1С, креатинин, и изчисляване на стойност на гломерулна филтрация въз основа на серумния креатинин (estimated Glomerular Filtration Rate - eGFR): (eGFR), урея, общ белтък, албумин, общ билирубин, глюкурониран билирубин (директен), желязо, ЖСК, АсАТ, АлАТ, КК, АФ, ГГТ, амилаза, пикочна киселина, холестерол, триглицериди, холестерол в HDL, холестерол в LDL, калий, натрий, калций, неорганичен фосфат;
...
23.1.3.3. (нова - ДВ, бр. 15 от 2025 г.) изчисляване на стойност на гломерулна филтрация въз основа на серумния креатинин (eGFR):

23.1.3.3.1. (нова - ДВ, бр. 15 от 2025 г.) по следната CKD-EPI формула, която включва серумните нива на креатинин в mg/dl, пола и годините на пациента:

eGFRcr = 142 x min (Scr/k, 1)? x max (Scr/k, 1) -1.200 x 0.9938 години x 1.012 [за жени], където:

Scr = стандартизиран серумен креатинин в mg/dL;

k = 0.7 (жени) или 0.9 (мъже);

? = -0.241 (жени);

или

23.1.3.3.2. (нова - ДВ, бр. 15 от 2025 г.) по следната CKD-EPI формула, която включва серумните нива на креатинин в mmol/l, пола и годините на пациента:
...
= 142 x (Scr /79.56)-1.200 x 0.9938Age

SCr* - серумна концентрация на креатинин в µmol/L;

или

23.1.3.3.3. (нова - ДВ, бр. 15 от 2025 г.) със следния онлайн базиран електронен калкулатор - за възрастни над 18 години:
...
23.1.4.2. ензимно определяне с уриказа, каталаза, алдехиддехидрогеназа и директна спектрофотометрия (UV метод);
...
Максимално допустимо процентно отклонение на средна аритметична (n=10) от "прицелната стойност"
