...
9. Посочената партида е негодна за:
...
Трите имена на производителя/търговеца
...
3. Тарифен номер (custom code)

4. ИК на ТЗ №

(identification code)

5. Местоназначение/Destination
