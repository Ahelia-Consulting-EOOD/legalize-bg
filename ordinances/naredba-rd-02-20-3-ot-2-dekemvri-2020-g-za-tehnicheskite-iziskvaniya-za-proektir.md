...
3. план на всяка конфигурация на система от стандартния набор, в който е даден нейният клас по натоварване и по широчина на работните площадки, пълните и размери, схемата на анкериране и начинът за включване на спомагателните компоненти;
...
4. информация за предварително огъване на елементите за намаляване на деформациите при натоварване;
