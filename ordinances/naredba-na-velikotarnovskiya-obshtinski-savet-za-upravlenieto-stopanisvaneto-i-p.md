...
1. опазване и увеличаване на площта на горите;

2. поддържане и подобряване състоянието на горите;

3. природосъобразно стопанисване на горските територии;

4. публичност, прозрачност и равнопоставеност;

5. свободна и лоялна конкуренция;

6. недопускане на дискриминация;

7. насърчаване на инвестиции за устойчиво стопанисване на горите и ползването на дървесина и недървесни горски продукти.
...
4. защита на природното и културно наследство; производство на дървесни и недървесни горски продукти; регулиране на климата и усвояване на въглерода.
...
2. начин за изпълнение на задължения на общината, произтичащи от договор с друга община или между общината и държавата;
...
5. способ за промяна на собствеността върху съществуващи горски автомобилни пътища или части от тях между, общината, държавата и горски сдружения. за изпълнение на задължения, произтичащи от международни договори.
...
1. върху имотите - собственост на трети лица, са учредени ипотека или други вещни права и тежести;
...
3. имотите - предмет на замяна, са отдадени под наем или под аренда; в резултат на замяната се разделят имоти - общинска собственост.
...
**Чл. 16.** (1) Ползването от горски територии - общинска собственост се осъществява след решение на Великотърновски общински съвет по един от следните начини: чрез продажба на стояща дървесина на корен; чрез добив и продажба на добита дървесина.
...
(9) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Годишният план по ал. 7 се одобрява с решение на Великотърновски общински съвет по предложение на кмета на община Велико Търново и се публикува на интернет страницата на община Велико Търново в срок 15 дни от одобряването му.
...
3. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) електронен търг с наддаване;

4. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) електронен таен търг с еднократно ценово предложение;

5. (предишна т. 3 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) конкурс;

6. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) електронен конкурс за продажба

7. (предишна т. 4 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) по ценоразпис.
...
(2) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Класирането на участниците при провеждане на конкурс и електронен конкурс се определя въз основа на оценките на офертите по критерий икономически най-изгодна оферта.

**Чл. 20.** (1) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) При провеждане на търг с явно наддаване участват участниците или техни упълномощени представители, които представят документ за самоличност.
...
6. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) условия за допускане на участниците до участие;
...
11. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) място, ден и час за провеждане на търга и срок за подаване на документите за участие;

12. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) информация дали възложителят допуска наемане на подизпълнители от спечелилия процедурата участник;

13. (предишна т. 12 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) допълнителни изисквания към купувача.

(4) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Размерът на стъпката за наддаване е от 1 до 3 на сто от началната цена на обекта, без ДДС.
...
2. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) изисквания, на които трябва да отговарят участниците;

3. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) документи, които следва да бъдат представени от участниците при участие в търга;

4. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) основания за недопускане или отстраняване на участниците от участие в търга;

5. проект на договор;

6. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) други условия и изисквания към участниците.

(2) Към документацията по ал. 1 се прилага копие от заповедта за откриване на търга.

(3) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Заповедта за откриване на търга, ведно с документацията за участие се публикува най - малко 15 дни преди крайният срок за подаване на документите за участие на интернет страницата на общината и се поставя на видно място в сградата.

(4) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) При изготвяне на документите си за участие всеки участник трябва да се придържа точно към обявените условия.

(5) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) До изтичането на срока за подаване на документите за участие в търга всеки участник може да ги оттегли, промени или допълни.

(6) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) За участие в търга участниците подават заявление по образец, в което посочват обекта, за който се отнася, и прилагат:

1. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) декларация, че участникът е внесъл гаранция за участие в търга за съответният обект и не е:
...
г) (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) свързано лице по смисъла на § 1, т. 15 от Допълнителните разпоредби на ЗПКОНПИ с Директора на ОП "Горско стопанство" и съответно с Кмета на Община Велико Търново;

д) (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) сключил договор с лице по чл. 68 ЗПКОНПИ;
...
3. (отм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.)

4. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) доказателства, че кандидатът, заедно с посочените от него подизпълнители отговаря на изискванията, когато такива са определени в условията за провеждане на търга;
...
(7) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Когато участникът в процедурата предвижда участие на подизпълнители, това се вписва в офертата. В този случай към офертата се прилагат документите по ал. 6, т. 1 и т. 2 за всеки посочен подизпълнител.
...
(9) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Когато участникът в търга е чуждестранно юридическо лице или е посочен подизпълнител, който е чуждестранно физическо или юридическо лице, документите по ал. 6, които са на чужд език, се представят в официално заверен превод.
...
(12) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Не се приемат за участие в търга и се връщат незабавно на участниците документите, които са представени след изтичане на крайният срок за получаване или в незапечатан, прозрачен или скъсан плик. Тези обстоятелства се отбелязват в регистъра по ал. 11.

(13) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Документите може да се представят и по електронен път при условията и по реда на Закона за електронния документ и електронния подпис. В този случай участникът е длъжен да представи на общината всички документи, които не са в електронен вид по реда на ал. 1, преди изтичането на срока за подаване на документите за участие.
...
(2) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Комисията се състои от нечетен брой членове - най-малко трима, от които един притежаващ необходимата квалификация - висше лесовъдско образование, а при липса на такъв специалист - със средно лесовъдско образование, един правоспособен юрист и един икономист.
...
2. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) не са "свързани лица" по смисъла на § 1 от допълнителните разпоредби на Търговския закон с участникът в търга или с посочените от него подизпълнители, или с членове на техните управителни или контролни органи;
...
(9) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Комисията има право по всяко време да проверява заявените данни и факти от участниците, както и да изисква в определен от нея срок допълнителни доказателства за обстоятелствата, изложени в офертата на кандидата.

**Чл. 23.** (1) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Комисията започва работа след получаване на списъка с участниците и представените от тях документи.
...
(3) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Комисията отваря документите на участниците по реда на тяхното постъпване и проверява дали са оформени съгласно изискванията на продавача.

(4) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Комисията проверява информацията, посочена в заявленията на участниците, за която има служебен достъп.

(5) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Комисията отстранява от участие в търга участник:
...
2. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) за когото се установи невярно деклариране на обстоятелство по чл. 21, ал. 6, т. 1.

(6) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) След допускане на участниците до следващия етап на търга, комисията предоставя на всеки от участниците пореден номер за участие.
...
(11) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Когато в явен търг участват повече от двама участници, предложили еднаква цена с една стъпка по-ниска от достигнатата, класираният на второ място се определя чрез жребий.

(12) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Когато в явен търг участват повече от един участник, но само един от тях е потвърдил началната цена, той се обявява за спечелил търга. Когато повече от един участници са потвърдили началната цена, спечелилият участник и класираният на второ място се определят чрез жребий. Не се възстановява гаранцията за участие на допуснатите до участие участници, които не са потвърдили началната цена.

(13) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Действията на комисията до изготвянето на протокола са публични.

(14) (Нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) Комисията съставя протокол за разглеждане на документите и класиране на участниците, който се предава за утвърждаване на органа, открил търга, ведно с цялата документация, събрана в хода на провеждането му.

**Чл. 24.** (1) Търгът с явно наддаване завършва със заповед на Кмета на Община Велико Търново за:

1. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) обявяването на класирането на участниците на първо и второ място и определяне на купувач, или
...
(3) (Нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) В заповедта по ал. 1, т. 1 може да се включи разпореждане за предварително изпълнение при условията и по реда на АПК.
...
(2) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Когато в търг с явно наддаване е допуснат само един участник, той се обявява за спечелил търга при цена не по-ниска от обявената в заповедта начална цена за обекта.

(3) (Отм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.)

**Чл. 26.** (1) Органът, открил търга, го прекратява с мотивирана заповед, когато:

1. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) не е подадено нито едно заявление за участие;

2. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) участникът не отговаря на условията за провеждане на търга;

3. (отм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.)

4. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) първият и вторият класиран участник откажат да сключат договор;
...
5. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) чрез електронна търговия (електронен търг);

6. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) чрез електронен таен търг с еднократно ценово предложение;

7. (предишна т. 6 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) чрез стоковата борса.
...
(7) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Предлагането на дървесината на стоковата борса се оповестява 15 дни преди датата на борсовата сесия на електронната страница на Община Велико Търново.
...
**Чл. 28а.** (Нов - Решение № 360 по Протокол № 15 от 29.10.2020 г.) При сключване на договор за продажба на стояща дървесина на корен със спечелилия кандидат и преди започване на дейността в съответният обект той предоставя на продавача документ за внесена или учредена в ползва на продавача гаранция за изпълнение на договора, както и следните документи, включително за подизпълнителите, когато е предвидено участието им:
...
(4) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Заповедта за класиране на участниците в търговете за продажба на дървесина, както и заповедта за прекратяването им се съобщават по реда на чл. 61 от АПК и се публикуват на интернет страницата на Община Велико Търново.
...
**Чл. 30.** (Изм. с Решение № 1437 по Протокол № 57 от 27.07.2023 г.) (1) Продажба по ценоразпис може да се извършва на:
...
2. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) при неявяване на участници на проведена процедура;
...
2. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) предмет и обект на процедурата, количество или обем и място на извършване на дейността;

3. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) стойност на обекта без ДДС;

4. срок за изпълнение на възлаганите дейности;

5. документи, които кандидатите трябва да представят;

6. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) размер на гаранцията за участие и вид и размер на гаранцията за изпълнение на договора;

7. изисквания към формата и съдържанието на офертите;

8. критерии за класиране на офертите;

9. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) възможност кандидатите да подават оферти само за един, за всички или за повече от един обект от предмета на процедурата;
...
(5) (Нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) В процедурите по договаряне не се допуска участието на подизпълнители.

(6) (Предишна ал. 5 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) Членовете на комисията декларират, че:
...
(7) (Предишна ал. 6 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) В деня, определен в заповедта, комисията провежда договарянето с кандидатите. Когато при започване на договарянето не присъства кандидатът или негов упълномощен представител, комисията отстранява кандидата от по-нататъшно участие, без да отваря плика с офертата му.

(8) (Предишна ал. 7 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) Комисията не провежда договаряне с кандидат, който не е представил някой от изискуемите от възложителя документи.

(9) (Предишна ал. 8 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) Комисията има право по всяко време да проверява заявените данни и факти от кандидатите, както и да изисква допълнителни доказателства за обстоятелствата, изложени в офертата на кандидата.

(10) (Предишна ал. 9 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) В деня на провеждане на договарянето комисията съставя протокол за работата си, който се предава на Кмета на общината за утвърждаване заедно с цялата документация, събрана в хода на провеждане на договарянето. Направените предложения и постигнатите договорености с всеки кандидат се описват в отделен протокол, който се подписва от членовете на комисията и от кандидата.
...
(13) (Предишна ал. 12 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) Кмета на общината утвърждава протокола по ал. 9 в 3-дневен срок от приключване работата на комисията и сключва писмен договор с кандидата, определен за изпълнител, след представяне на гаранцията за изпълнение.

(14) (Предишна ал. 13 - Решение № 360 по Протокол № 15 от 29.10.2020 г.) В срока по ал. 12 утвърденият протокол се съобщава по реда на чл. 61 от АПК и се публикува на електронната страница на Община Велико Търново.
...
**Чл. 34б.** (Нов - Решение № 360 по Протокол № 15 от 29.10.2020 г.) (1) Продавачът, открил електронния търг, издава заповед за назначаване на комисия за провеждането му, като определя нейния състав и резервни членове.
...
**Чл. 34в.** (Нов - Решение № 360 по Протокол № 15 от 29.10.2020 г.) (1) Комисията започва работа след получаването на списъка с участниците и на представените от тях документи.
...
**Чл. 34г.** (Нов - Решение № 360 по Протокол № 15 от 29.10.2020 г.) (1) Електронният търг с наддаване стартира с началната цена за обекта, след потвърждаването на която започват стъпките на наддаване.
...
**Чл. 34е.** (Нов - Решение № 360 по Протокол № 15 от 29.10.2020 г.) (1) Електронният търг завършва със заповед на открилия процедурата продавач за:
...
1. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) търг с явно или тайно наддаване - за продажба на добита дървесина на прогнозни количества;

2. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) търг с явно или тайно наддаване - за продажба на стояща дървесина на корен.

3. (отм. - Решение № 360 по Протокол № 15 от 29.10.2020 г.)

(5) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) В процедурите за сключване на дългосрочни договори за продажба на стояща дървесина на корен могат да участват търговци, регистрирани в публичния регистър по чл. 241 от Закона за горите и притежаващи удостоверение за регистрация за следните дейности:
...
(8) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) При сключване на дългосрочен договор по реда на ал. 4, т. 2 спечелилият участник представя на продавача документите, посочени в чл. 28а.

(9) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Община Велико Търново публикува заповедта за откриване на търга и документацията за провеждането му най-малко 30 дни преди крайния срок за подаване на документите за участие на своята интернет страница като същевременно ги поставя и на видно място в сградата.

(10) Заповедта за откриване на търга или конкурса се публикува в срока по ал. 9 и в един централен всекидневник.

(11) (Нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) В процедурите по чл. 35, ал. 4, т. 2 могат да участват търговци, които представят доказателства за наличие на необходимата собствена техника и наети на трудов договор работници.

**Чл. 36.** (1) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) В заповедта за откриване на търг за сключване на дългосрочни договори за продажба на дървесина, задължително се определят:
...
3. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) обемът на дървесината по години за срока на договора;

4. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) начална цена за провеждане на търга;
...
(2) (Отм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.)

**Чл. 37.** (1) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Участниците за участие в процедурите по чл. 35, ал. 4 представят гаранция за участие, а определените купувачи представят гаранция за изпълнение.

(2) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Община Велико Търново определя условията и размера на гаранцията за участие в размер от 3 до 5 на сто от началната цена на обявеното на търга количество дървесина за първата календарна година от договора.

(3) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Определеният купувач всяка година представя гаранция за изпълнение, която е в размер от 3 до 5 на сто от стойността на договореното за съответната година количество дървесина.
...
**Чл. 39.** (1) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Въз основа на резултатите от проведения търг Кметът на Община Велико Търново сключва с участника, определен за купувач, писмен договор.

(2) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Община Велико Търново може да включи в заповедта за класиране на участниците разпореждане за предварително изпълнение при условията и по реда на АПК.

**Чл. 40.** (1) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Ежегодно до 31 януари към договора по чл. 39 се подписва допълнително споразумение, с което за текущата календарна година се определят актуалната стойност на гаранцията за изпълнение на договора, както и:
...
(2) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Гаранцията за изпълнение за първата година от договора не се възстановява, а се актуализира до стойността по ал. 1, след което допълнителното споразумение влиза в сила.
...
5. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) купувачът престане да отговаря на изискванията за сключване на договор по чл. 35, ал. 5, ал. 6, ал. 8 и ал. 10.
...
(2) (Изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) Ползването на недървесни горски продукти, собственост на Община Велико Търново, когато представлява стопанска дейност, се осъществява по един от следните начини:
...
3. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) чрез издаване на позволително за ползване на недървесни горски продукти за съответната календарна година.
...
(6) (Нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) Заповедта по ал. 1 се предоставя в срок до 10 март в съответната регионална дирекция по горите и съответната регионална инспекция по околна среда и водите, в чийто териториален обхват попадат горските територии.
...
#### Раздел I. Строител ство в горски територии – собственост на общината без промяна на предназначението
...
11. (изм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.) "Обект" е:
...
21. (отм. с Решение № 360 по Протокол № 15 от 29.10.2020 г.)
...
24. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) "Карнет-опис" е документ по смисъла на чл. 50, ал. 10 от Наредба № 8 от 2011 г. за сечите в горите (ДВ, бр. 64 от 2011 г.), издаден по образец, утвърден от изпълнителния директор на Изпълнителната агенция по горите.

25. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) "Асортимент" е необработен дървен материал, определен съобразно неговото качество, размери и приложение в съответствие с договор или с утвърден от правоимащ орган стандарт.

26. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) "Преработка на дървесина" е процес на употреба на дървесината в сферата на дъскорезното, амбалажното и мебелното производство, производствата от целулозно-хартиената промишленост, производствата на плочи от дървесни частици и влакнести плочи и други крайни продукти с изключение на продуктите, получени само чрез цепене или дробене.

27. (нова - Решение № 360 по Протокол № 15 от 29.10.2020 г.) "Продавач" е лице, което провежда процедури за продажба на дървесина.
