...
1.3.1.1. (изм. - ДВ, бр. 63 от 2021 г.) структура по образна диагностика съгласно медицински стандарт "Образна диагностика", с възможност за извършване на необходимите за дейността изследвания;

1.3.1.2. (изм. - ДВ, бр. 63 от 2021 г.) структура по клинична лаборатория, напълно оборудвана, отговаряща на съответния стандарт, работеща изцяло или предимно за сърдечната хирургия и осигуряваща необходимите изследвания 24 часа в денонощието;

1.3.1.3. (изм. и доп. - ДВ, бр. 63 от 2021 г.) структура по анестезиология и интензивно лечение, осъществяваща интензивно лечение и отговаряща на съответния стандарт.

1.3.2. Клиниката/отделението по кардиохирургия трябва да има осигурен достъп на територията на лечебното заведение до:

1.3.2.1. (изм. - ДВ, бр. 63 от 2021 г.) клиника/отделение по инвазивна кардиология, отговаряща на съответния стандарт и осигуряваща медицинска помощ при спешност 24 часа в денонощието;
...
1.3.2.5. (изм. - ДВ, бр. 63 от 2021 г.) в случаите, когато в клиниката/отделението по кардиохирургия се извършват кардиохирургични операции на новородени - клиника/отделение по педиатрия и/или клиника/отделение по неонатология с пълен набор от възможности за диагностика и лечение;
...
1.3.3.1. (изм. - ДВ, бр. 63 от 2021 г.) клиника/отделение по клинична хематология;

1.3.3.2. (изм. - ДВ, бр. 63 от 2021 г.) клиника/отделение по пневмология и фтизиатрия или самостоятелна възможност за извършване на пулмофункционален тест (функционално изследване на дишането);

1.3.3.3. (изм. - ДВ, бр. 63 от 2021 г.) клиника/отделение по нефрология;

1.3.3.4. (изм. - ДВ, бр. 63 от 2021 г.) клиника/отделение по образна диагностика, разполагаща с компютърна аксиална томография и/или ядрено-магнитен резонанс;

1.3.3.5. (изм. - ДВ, бр. 63 от 2021 г.) клиника/отделение по нервни болести;

1.3.3.6. клиника/отделение по нуклеарна медицина;

1.3.3.7. клиника/отделение по обща и клинична патология;

1.3.3.8. (изм. - ДВ, бр. 63 от 2021 г.) клиника/отделение по инфекциозни болести;

1.3.3.9. клиника/отделение по акушерство и гинекология;

1.3.3.10. център/клиника/отделение по трансфузионна хематология;

1.3.3.11. (изм. - ДВ, бр. 63 от 2021 г.) клиника/отделение по урология;
...
3.4.5.2.1. (изм. и доп. - ДВ, бр. 63 от 2021 г.) Клиниката/отделението по кардиохирургия трябва да разполага с лекар/и със специалност "Кардиохирургия", осигуряващи оказване на пълноценни грижи за изпълнявания обем и сложност на дейността.
...
3.4.5.2.2. (изм. - ДВ, бр. 63 от 2021 г.) В клиниката/отделението по кардиохирургия трябва да има допълнително лекар/и със и без специалност, осигуряващи оказване на пълноценни грижи за изпълнявания обем и сложност на дейността.

3.4.5.2.3. (изм. - ДВ, бр. 63 от 2021 г.) В клиниката/отделението по кардиохирургия трябва да има лекари със специалност "Кардиология", от които поне единият да бъде с допълнителна квалификация по ехокардиография.
...
3.4.5.4.5. (изм. - ДВ, бр. 63 от 2021 г.) В клиниката/отделението по кардиохирургия трябва да има рехабилитатори, които изпълняват дейността съгласно квалификацията си и професионалните си компетентности, в съответствие с този стандарт и медицинския стандарт "Физикална и рехабилитационна медицина".

3.4.5.4.6. (изм. - ДВ, бр. 63 от 2021 г.) В клиниката/отделението по кардиохирургия трябва да има хигиенисти.
