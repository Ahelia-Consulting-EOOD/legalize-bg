...
8. номиналната стойност на прехвърляните ДЦК (цифром), която трябва да е най-малко 1 евро и да е кратна на 0.01 евро;
...
(2) Сертификатът по ал. 1 се изготвя върху специална хартия с размери 21 х 15 см по образец (приложение № 31) и съдържа:
...
(5) При продажба на ДЦК, предназначени за индивидуални инвеститори - физически лица (целеви емисии), на приобретателя се издава поименен сертификат върху специална хартия с размери 21 х 16 см по образец (приложение № 32), който освен данните по ал. 2, т. 1 - 12 съдържа:
