...
**Чл. 10.** (1) Одит за пътна безопасност е независима, подробна, систематична проверка за техническа безопасност на проектните характеристики на пътната инфраструктура, неразделна част от процеса на инвестиционното и проектиране, строителство и експлоатация, и се извършва задължително на следните етапи:
...
**Чл. 67.** (1) Дейността по обезопасяване на участъците с концентрация на ПТП се планира от администрацията, управляваща пътя, и се включва в рамките на инвестиционната и програма.
