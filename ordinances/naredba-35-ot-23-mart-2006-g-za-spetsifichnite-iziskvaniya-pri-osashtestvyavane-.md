...
(2) Официалният ветеринарен лекар контролира здравната маркировка и използваните материали за поставянето и.
...
8. принципи, понятия и методи на системата НАССР и използването и в производствената и хранителната верига;
