...
(4) При констатиране на несъответствия по реда на предходните алинеи, както и в случаите на влизане в сила на изменения на ОУП, промените в данните от цифровия вид на ОУП се извършват след разрешение на Главния архитект на Столична община.
...
3. устройства за отдалечен достъп до данните - терминали за наблюдение на данните, поставени на места за публичен достъп, определени от Главния архитект на Столична община.
