...
**Чл. 25.** (1) Министърът на околната среда и водите или директорът на РИОСВ издава наказателно постановление на основание чл. 37 ЗЗШОС въз основа на акта за установяване на административно нарушение по чл. 24.
...
1 наименование, ЕИК/БУЛСТАТ, седалище и адрес на юридическото лице или име, адрес и ЕГН на физическото лице;
...
ХАРАКТЕРИСТИКА НА ПУНКТА:

1. Вид на пътното покритие
...
пътя (при норма 7,5 m)

РЕЗУЛТАТИ ОТ ИЗМЕРВАНЕТО НА ШУМА
...
I. Данни за промишления източник на шум:
...
Настоящият протокол се изготви в два еднакви екземплярапо един за всяка страна.
...
Законен представител на оператора на промишленияи зточник или упълномощено от него лице:
...
* Попълва се в случай, че законният представител на оператора или упълномощеното от него лице откаже да подпише протокола.
...
7. Резултати от изпитването/измерването
...
7.2. Изпитвания/измервания, извършени от подизпълнител **
...
7.3.Изпитвания/измервания извън обхвата на акредитация**
...
АБЕЛЕЖКА І: Ако е необходимо, протоколът от изпитване може да включва мнения и интерпретации за определени изпитвания (заключения не се допускат) само в съответствие с изискванията на т.5.10.5 от БДСЕN ISO/IEC 17025.
