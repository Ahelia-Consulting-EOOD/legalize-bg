...
(4) (Изм. - ДВ, бр. 34 от 2015 г., в сила от 18.05.2015 г.) Широчината на единичната непрекъсната линия при двулентов път и при път с повече от три ленти е 0,10 m, а на автомагистрали, скоростни пътища и скоростни градски магистрали - 0,15 m.
...
**Чл. 14.** (1) Предупредителната линия предхожда винаги единичната непрекъсната линия и предупреждава за приближаването към нея. Изображението и е показано в приложение № 5, позиция "а".

(2) Предупредителната линия се изпълнява с единична прекъсната линия. Размерите и са определени в приложение № 6.
...
(2) Шлюзовата линия се изпълнява като продължение на крайната линия. Размерите и са определени в приложение № 8.
...
**Чл. 57.** (1) (Изм. - ДВ, бр. 34 от 2015 г., в сила от 18.05.2015 г.) Дължината и местоположението на единичните непрекъснати линии в зоните на хоризонтални криви при двулентов път се определят в зависимост от разстоянието за видимост M съгласно приложение № 37.
...
19. (нова - ДВ, бр. 34 от 2015 г., в сила от 18.05.2015 г.) "Надлъжна релефна шумна пътна маркировка" е пътна маркировка, чиято текстура на повърхността осигурява видимостта и при наличие на воден пласт в резултат на интензивен дъжд и причинява при застъпването и шум и вибрации в автомобила.
...
а) "Единична непрекъсната линия" - М1

б) "Двойна непрекъсната линия" - М2

в) "Единична прекъсната линия" - М3

г) "Двойна прекъсната линия" - М4

д) "Двойна смесена линия" - М5
...
Размери на предупредителната линия
...
Дължина на участък с предупредителна линия
...
Размери на заустваща и шлюзова линия
...
Размери на стрелките при допустима максимална скорост на движение V > 50 km/h

- в зоната за изчакване и за престрояване на кръстовище:

- в зоната за изчакване и за престрояване на кръгово кръстовище, когато тя е с повече от една лента:

Размери на стрелките при допустима максимална скорост на движение V GBP 50 km/h
...
Пътна маркировка "Стрелки за насочване" - М12

Размери на дясна стрелка

Размери на лява стрелка
...
Паркиране върху пътното платно

Паркиране върху обособени площи извън пътното платно
...
Размери на буквите при допустима максимална скорост на движение V GBP 50 km/h

Размери на буквите при допустима максимална скорост на движение V > 50 km/h.
...
Размери на цифрите при допустима максимална скорост на движение V GBP 50 km/h

Размери на цифрите при допустима максимална скорост на движение V > 50 km/h.
...
а) Обозначаване на допустимата максимална скорост на движение върху пътната настилка на път с допустима максимална скорост на движение V GBP 50 km/h

б) Обозначаване на допустимата максимална скорост на движение върху пътната настилка на път с допустима максимална скорост на движение V > 50 km/h.
...
Размери на символите с международно значение при допустима максимална скорост на движение V < 50 km/h

Размери на символите с международно значение при допустима максимална скорост на движение V > 50 km/h

Размери на символ, предупреждаващ за приближаване към път с предимство, при допустима максимална скорост на движение:

V GBP 50 km/h - x = 0,50, y = 2,00, z = 1,00

V > 50 km/h - x = 1,00, y = 6,00, z = 2,00.
...
Пътна маркировка на път с четири и повече пътни ленти със средна разделителна ивица

а) път с бордюри

б) автомагистрали и скоростни градски магистрали
...
Пътна маркировка на допълнителни и специализирани пътни ленти
...
L - съгласно приложение № 7

D - разстояние, преминавано за време 1 s

при V > 50 km/h-1:i <= 1:50

при V <= 50 km/h-1:i <= 1:20
...
двупосочен път в хоризонтална крива
...
а) лента за забавяне на движението

б) лента за ускоряване на движението
...
D - разстояние, преминавано за 1 s
...
а) пред препятствие върху пътната настилка и пред остров върху платното за движение

1:i - съответства на наклона на крайните линии

б) пред начало на разделителна ивица
...
а) площадка за принудително спиране и разминаване

б) площадка за спирка на нерелсови превозни средства за обществен превоз на пътници
