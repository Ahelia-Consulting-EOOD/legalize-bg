...
ЗИУ 4: Опазване на естествените местообитания и на дивата флора и фауна (Директива 92/43/ЕИО).

Приложение № 3 към чл. 55, ал. 2

Оптимални разходни норми (на ха) на допустимите зърнено-житни култури и слънчоглед,
