...
**Чл. 16.** (1) Изпращачът е длъжен да предаде на оператора товарите натоварени, подредени и укрепени в автомобилите и интермодалните транспортни единици съгласно изискванията на отделните видове транспорт и в съответствие със спецификата на превозваните товари.

(2) Когато транспортната опаковка е неподходяща, операторът може да приеме товара, при условие че изпращачът заяви писмено, че вредите, които биха настъпили, са за негова сметка.
...
**Чл. 18.** (1) Натоварването/разтоварването и укрепването на интермодалните транспортни единици е задължение на изпращача/получателя, освен ако не е уговорено друго.

(2) Изпращачът може да пломбира със свои пломби натоварените интермодални транспортни единици. Ако операторът присъства при натоварването, той пломбира интермодалните транспортни единици със свои пломби.
...
**Чл. 21.** (1) Товарите се считат за доставени, когато са предадени или оставени на разположение на получателя или негов представител в съответствие с условията на договора.

(2) Договорът за комбиниран превоз на товари се счита за изпълнен от момента, в който получателят или упълномощено от него лице след доставката на товара е получил срещу подпис превозния документ.
...
**Чл. 27.** (1) Размерът на обезщетението в случаите по чл. 24, ал. 1 се определя спрямо стойността на товара на мястото и по времето на доставката в съответствие със специфичните разпоредби за видовете транспорт.

(2) Размерът на обезщетението в случаите по чл. 24, ал. 2 се определя съобразно стойността на оценката, но не повече от стойността на интермодалната транспортна единица.
