...
2. Данни за източниците и условията на излъчване на шум.
...
3. Данни за населението и ползването на територията:
...
4. Метеорологични данни.

5. Измерени и/или изчислени данни за нивата на шума в dB(A).
...
2. Данните от проведените измервания и/или изчисления се прилагат към документацията на стратегическите карти за шум, като се посочват и използваните методи за измерване и/или изчисление.

3. В стратегическата карта за шум се отбелязват задължително наименованието на съответния обект, годината, за която е съставена, и легенда, поясняваща смисъла на използваните означения.

4. В текстова форма се посочват:
...
2. За основните пътища, железопътни линии и летища:
