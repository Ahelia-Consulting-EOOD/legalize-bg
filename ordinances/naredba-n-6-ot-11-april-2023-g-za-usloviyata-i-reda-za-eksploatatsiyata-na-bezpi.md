...
1. (изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) трите имена и ЕГН за българските граждани, ЛНЧ и дата на раждане за чуждите граждани, а за юридическите лица - фирмата и техния единен идентификационен код (ЕИК);
...
6. (доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) номер на застрахователен договор за сключена застраховка "Гражданска отговорност" към трети лица и копие на застрахователната полица, в случай че се изисква такава застраховка;
...
(3) (Доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) За целите на регистрацията лицето попълва изискуемата информация по чл. 4, ал. 2, т. 1 - 7 в системата по ал. 2, като декларира, че същата е точна, и заплаща държавна такса.
...
(7) (Нова - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Всяка промяна в информацията по чл. 4, ал. 2, т. 1 - 6 подлежи на отразяване в регистъра, като за целта операторът на БЛС подава искане до ГД "ГВА" в 10-дневен срок от настъпването на промяната на обстоятелствата.
...
**Чл. 9.** (1) (Изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Кандидатът за получаване на свидетелство за преминато онлайн обучение за извършване на полети в подкатегории А1 и А3, определени в част А от приложението към Регламент за изпълнение (ЕС) 2019/947, преминава онлайн курс за обучение по темите, определени в чл. UAS.OPEN.020 от приложението към Регламент за изпълнение (ЕС) 2019/947, осигурен от ГД "ГВА" или от субект, определен от ГД "ГВА".

(2) (Изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Придобитите по време на обучението по ал. 1 знания от кандидата за свидетелство за преминато онлайн обучение за извършване на полети в подкатегории А1 и А3, определени в част А от приложението към Регламент за изпълнение (ЕС) 2019/947, се проверяват чрез полагането на онлайн теоретичен изпит, състоящ се от 40 въпроса, осигурен от ГД "ГВА" или от субект, определен от ГД "ГВА".
...
4. (изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) преминал допълнителен теоретичен изпит по чл. UAS.OPEN.030, подточка 2, буква "в" от част А от приложението към Регламент за изпълнение (ЕС) 2019/947, осигурен от ГД "ГВА" или от субект, определен от ГД "ГВА".

**Чл. 11.** За получаване на свидетелство за теоретични познания за експлоатация по основен сценарий кандидатът следва да е:

1. преминал онлайн курс за обучение и да е положил онлайн теоретичен изпит по чл. 9;

2. (изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) преминал допълнителен теоретичен изпит по притурка А към глава 1 на допълнение 1 от приложението към Регламент за изпълнение (ЕС) 2019/947, осигурен от ГД "ГВА" или от субект, определен от ГД "ГВА".
...
(2) Лицата по ал. 1 организират и извършват обучението и провеждането на съответните изпити в центрове при условията и по реда, предвидени в тази наредба, и в съответствие с изискванията на Регламент за изпълнение (ЕС) 2019/947.

**Чл. 28б.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) Центровете, в които се предоставя онлайн обучение и онлайн теоретичен изпит за подкатегории А1 и А3 и теоретичен изпит за подкатегория А2 и/или основен сценарий, трябва да отговарят на следните изисквания:

1. да разполагат най-малко с една изпитна зала, офис и санитарно помещение, намиращи се на един и същи адрес;

2. да имат ръководител на учебната и изпитната дейност;

3. да имат преподаватели и проверяващи, които притежават необходимата квалификация, съгласно изискванията на настоящата наредба и Регламент за изпълнение (ЕС) 2019/947.

**Чл. 28в.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) Помещението, използвано за изпитна зала, трябва да отговаря на следните изисквания:

1. да е собствено или наето;

2. височината на помещението да е не по-малка от 2,40 m и да има осигурена естествена светлина през деня и изкуствено осветление вечер;

3. да разполага с работно място и площ не по-малко от 1,5 m2 за всеки кандидат и работно място за проверяващия, като общата площ на помещението не може да е по-малка от 20 m2;

4. в него да се поддържа температура от 18° С до 24° С;

5. да не е преходно към други помещения.
...
**Чл. 28д.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) (1) Учебната и изпитната дейност в центъра се организира от ръководител на учебната и изпитната дейност.

(2) Ръководителят на учебната и изпитната дейност трябва да:

1. притежава диплома за висше образование най-малко с образователно-квалификационна степен "бакалавър" в областта на техническите науки, както са определени в Постановление № 125 на Министерския съвет от 2002 г. за утвърждаване Класификатор на областите на висше образование и професионалните направления (ДВ, бр. 64 от 2002 г.);

2. притежава валидно свидетелство за правоспособност за основен сценарий;

3. е разработвал методически материали, по които ще се предоставя обучението за подкатегории А1 и А3.

(3) Ръководителят на учебната и изпитната дейност е длъжен:

1. да осигурява спазването на изискванията на Регламент за изпълнение (ЕС) 2019/947, Закона за гражданското въздухоплаване и тази наредба;

2. своевременно да води съответните документи във връзка с проведените обучение и изпити;

3. при организиране провеждането на изпитите да осигурява спазването на дневната натовареност на проверяващите;

4. да обявява и актуализира информацията относно таксите за провеждане на обучението и изпитите.

**Чл. 28е.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) (1) Преподавателите в центъра трябва да притежават:

1. диплома за висше образование най-малко с образователно-квалификационна степен "бакалавър" в областта на техническите науки, както са определени в Постановление № 125 на Министерския съвет от 2002 г. за утвърждаване Класификатор на областите на висше образование и професионалните направления;

2. валидно свидетелство за правоспособност за основен сценарий.

(2) Преподавателите подлежат на периодично опреснително обучение за актуализация и усъвършенстване на познанията им на всеки 2 години от постъпването им на работа в центъра.

(3) Преподавателите разработват учебните материали за онлайн курса за обучение за категории А1 и А3, определени в част А от приложението към Регламент за изпълнение (ЕС) 2019/947.

**Чл. 28ж.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) Проверяващият изпита за подкатегория А2, определен в част А от приложението към Регламент за изпълнение (ЕС) 2019/947, и/или за основен сценарий, определен в притурка А към глава 1 на допълнение 1 от приложението към Регламент за изпълнение (ЕС) 2019/947, трябва да:

1. притежава най-малко диплома за средно образование;

2. е запознат с процедурите за проверяване на теста от съответния изпит, което се доказва с изготвяне на протокол при постъпване на работа.

**Чл. 28з.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) (1) Изпитите за подкатегория А2 и основен сценарий са присъствени.
...
**Чл. 28й.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) (1) Кандидатът за преминаване на онлайн курс за обучение и теоретичен онлайн изпит за категории А1/А3 се регистрира онлайн в информационната система на центъра, която осигурява възможност кандидатът да попълва следната информация:

1. име, презиме и фамилия;

2. ЕГН - когато информацията се предоставя от български гражданин, или номер на документ за самоличност - когато информацията се предоставя от чужденец;

3. адрес, електронен адрес и телефонен номер за кореспонденция.

(2) Кандидатите за явяване на изпит за подкатегория А2 или основен сценарий се записват в центъра, като предоставят информацията по ал. 1.

(3) При записване на кандидатите се предоставя информация относно условията и изискванията за явяване на изпит, формата на изпита и минимална успеваемост във връзка с чл. UAS.OPEN.020(4)(б), UAS.OPEN.030(2) и UAS.OPEN.040(3) от приложението към Регламент за изпълнение (ЕС) 2019/947 и чл. UAS.STS-01.020(2) от допълнение 1 към Регламент за изпълнение (ЕС) 2019/947.

(4) Не се допуска до изпит кандидат, който не покрива минималните изисквания за явяване на съответния изпит, както са определени в т. 2 от чл. UAS.OPEN.030 по отношение на изпит за подкатегория А2 и т. 2, буква "а" от чл. UAS.STS-01.020 по отношение на изпит за основен сценарий от Регламент за изпълнение (ЕС) 2019/947.
...
**Чл. 28л.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) (1) Лицето по чл. 28а подава информация в ГД "ГВА" за планираните изпити за подкатегория А2 и основен сценарий, включваща вид, дата и час за всеки изпит за съответния месец, до 25-о число на предходния месец.

(2) За изпити, планирани в текущия месец, информацията се подава незабавно. Делът на такива краткосрочно планирани изпити не трябва да надвишава 10 % от изпитите за съответния месец.
...
**Чл. 28н.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) (1) За изготвяне на тестовете за провеждане на теоретичните изпити се използват изпитни въпроси, предоставени от ГД "ГВА", по съдържанието на темите, както са определени в Регламент за изпълнение (ЕС) 2019/947.

(2) Лицето по чл. 28а използва предоставените въпроси само по предназначение за изготвянето на тестове и не може да ги разпространява.

(3) Тестовете за съответния вид изпит обхващат само темите за конкретния вид изпит. Тестът на всеки кандидат е индивидуален.
...
1. запознава кандидатите с условията и реда за провеждане на теоретичния изпит;

2. проверява самоличността на кандидатите;

3. уведомява кандидатите, явяващи се на теоретичен изпит, че по време на изпита кандидатът няма право да нарушава дисциплината, да комуникира с други кандидати и да ползва помощни материали, като учебници, учебни помагала или записки, а ако се установи нарушаване на правилата, изпитът на съответния кандидат се прекратява.

**Чл. 28п.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) (1) Лицето по чл. 28а предоставя информация в ГД "ГВА" за кандидатите, които са преминали успешно теоретичен изпит за дистанционно управляващи пилоти до 3 работни дни от датата на провеждане на изпита.

(2) Информацията по ал. 1 включва данните на кандидата, посочени в чл. 28й, ал. 1, и резултата от изпита в проценти.

**Чл. 28р.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) (1) Лицето по чл. 28а поддържа актуален списък на всички кандидати, положили изпит.

(2) Списъкът съдържа най-малкото следната информация за всеки кандидат, положил изпит:

а) трите имена, адрес, телефон;

б) ЕГН - за българските граждани, или номер на документ за самоличност - за чуждестранни граждани;

в) тип изпит (обучение и А1/А3; А2; основен сценарий);

г) проведен изпит (издържан/неиздържан, резултат xx.xx %);

д) прекратен изпит поради нарушаване на правилата;

е) място и дата на изпита;

ж) дата на уведомяване на ГД "ГВА" за издържалия кандидат.

(3) Списъкът с кандидати, положили изпит за съответната година, се изпраща в ГД "ГВА" до 31 януари на следващата година.

**Чл. 28с.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) Следните документи и записи се съхраняват по защитен начин от центъра за период от най-малко 3 години, след изтичане на валидността или от последното изменение на съответния документ, и се представят на ГД "ГВА" при поискване:

1. досие на кандидата за придобиване на свидетелство за дистанционно управляващ пилот, което съдържа:

а) заявление за явяване на изпит;

б) доказателства за покриване на изискванията за явяване на изпита;

в) документация от изпити, като протокол, включително тестовете, издържан или неиздържан изпит;

2. информация за опити за преписване;

3. списъци с кандидати (А1/А3, А2, основен сценарий);

4. въпросници (А1/А3, А2, основен сценарий);

5. документирана информация от системата за управление и наблюдение на съответствието, като ръководства, протоколи, контролни списъци, доклади от одит, записи;

6. досиета на персонала;

7. учебните материали за онлайн курса за обучение за подкатегории А1 и А3.
...
1. удостоверение за актуално състояние - за лицата, които са регистрирани като търговци по законодателството на друга държава - членка на Европейския съюз, или в друга държава - страна по Споразумението за Европейското икономическо пространство;

2. декларация, че срещу него не е подадена молба за откриване на производство по несъстоятелност, че не се намира в открито производство по несъстоятелност или ликвидация и/или че не е обявяван в несъстоятелност или в ликвидация;

3. описание на помещенията, които се ползват за изпитна зала и за офис, информация за собственика и основанието за ползването им от заявителя; ако документът, въз основа на който се ползват помещенията, не подлежи на вписване или не е вписан в имотния регистър, се представя копие от съответния документ;

4. информация за ръководителя на учебната и изпитната дейност, преподавателите и проверяващите ведно с доказателства за тяхната квалификация, включително копие на свидетелствата за правоспособност и дипломите за завършено образование на персонала, за които се изисква; диплома за завършено висше образование не се представя, когато документът е издаден след 1.01.2012 г. и е вписан в регистъра на всички действащи, прекъснали и завършили студенти и докторанти, по степени на обучение и по професионални направления или в регистъра за академично признаване, поддържан от Министерството на образованието и науката; в тези случаи се извършва служебна проверка в Националния център за информация и документация;

5. разработени от ръководителя на учебната и изпитната дейност примерни методически материали, по които ще се предоставя обучението за подкатегории А1 и А3, доказващи опита му;

6. ръководство за управление, съдържащо най-малко следното:

а) основна информация и описание на изпитния център;

б) организационна схема;

в) задачи и отговорности на персонала;

г) система за съхранение и архивиране на записите;

д) процедура за управление на промените;

е) продължаване валидността на одобрението за признат субект;

ж) процедура за отчитане на преминали кандидати;

з) поддържане на списък с изпитаните кандидати;

и) следене и проверка на съответствието със законовите изисквания и вътрешните процедури;

к) изисквания за квалификацията на персонала;

л) обучение и периодично (опреснително) обучение на персонала;

7. ръководство за обучение, съдържащо най-малко следното:

а) информация по отношение на изпитните въпроси;

б) процедура за докладване на изпитни дати;

в) процедура за проверка на изискванията към кандидатите;

г) описание на процеса на изпитване;

д) процедура за провеждане на присъствен изпит за А2/STS;

е) процедура за провеждане на контролиран онлайн изпит за А2/STS;

ж) процедура за провеждане на онлайн обучение и изпит за А1/А3;

з) описание на стаите за изпит.

(2) Заявлението по ал. 1 се подава от лицето по чл. 28а чрез законния му представител или от упълномощено от него лице по реда на чл. 18 от Административнопроцесуалния кодекс в центъра за административно обслужване на ГД "ГВА" чрез лицензиран пощенски оператор или по електронен път с квалифициран електронен подпис чрез електронния портал за заявяване на административни услуги на ГД "ГВА".

(3) При установяване на непълноти или неточности в подаденото заявление или приложените към него документи заявителят се уведомява писмено от главния директор на ГД "ГВА" или оправомощено от него длъжностно лице в 14-дневен срок. Заявителят е длъжен да отстрани допуснатите непълноти или неточности в 14-дневен срок от получаване на уведомлението.

(4) Когато подателят на заявлението не представи изискуемата информация и документи в определения срок, процедурата се прекратява със заповед на главния директор на ГД "ГВА". Заповедта подлежи на обжалване по реда на Административнопроцесуалния кодекс.

(5) Главният директор на ГД "ГВА" или оправомощено от него длъжностно лице издава одобрението по чл. 28а или мотивирано отказва издаването му, като посочва несъответствията с изискванията.

(6) Отказът подлежи на обжалване по реда на Административнопроцесуалния кодекс.

(7) Издаването на одобрението или удължаването на срока му на валидност се извършва в 30-дневен срок от получаването на заявлението или от отстраняването на непълнотите или неточностите.

(8) В одобрението се посочва обхватът на конкретните права и услуги, които центърът ще предоставя, и се издава за срок от 2 години. Срокът на валидност на одобрението се удължава за нови 2 години, когато лицето по чл. 28а, ал. 1 е подало заявление за това не по-късно от 30 дни преди изтичането на срока на валидност на одобрението и продължава да отговаря на изискванията на тази наредба.

(9) Одобрението е поименно и не подлежи на преотстъпване.

**Чл. 28х.** (Нов - ДВ, бр. 114 от 2025 г., в сила от 26.06.2026 г.) (1) За промяна в обстоятелствата в документите по чл. 28ф, ал. 1 лицата по чл. 28а подават в ГД "ГВА" заявление, към което прилагат само съответните документи по чл. 28ф, ал. 1, удостоверяващи исканата промяна, като заплащат държавна такса.

(2) Промяната се извършва в срок до 14 дни от датата на подаване на заявлението или от отстраняване на непълноти или неточности.

(3) Заявленията по ал. 1 се подават от законния представител по чл. 28а или упълномощено от него лице по реда на чл. 18 от Административнопроцесуалния кодекс в център за административно обслужване на ГД "ГВА" чрез лицензиран пощенски оператор или по електронен път с квалифициран електронен подпис чрез електронния портал за заявяване на административни услуги на ГД "ГВА".
...
1. (изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) декларация, че срещу него не е подадена молба за откриване на производство по несъстоятелност, че не се намира в открито производство по несъстоятелност или ликвидация и/или че не е обявяван в несъстоятелност или в ликвидация;

2. организационни и оперативни процедури съгласно чл. 16, параграф 2, буква "б" от Регламент за изпълнение (ЕС) 2019/947;

3. (изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) списък на отговорните лица за осигуряване на безопасност при експлоатацията, обучението на служителите или членовете и координация със засегнатите субекти;
...
(2) (Изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Документацията на оператора на БЛС по ал. 1 се изготвя в два еднообразни екземпляра - за оператора и за ГД "ГВА", и в съответствие с изискванията на правилата за извършване на оценка на експлоатационния риск по чл. 11 от Регламент за изпълнение (ЕC) 2019/947 и Приемливите средства за съответствие (AMC 1) към чл. 11 от Регламент за изпълнение (ЕС) 2019/947.
...
(2) (Изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) В декларацията по ал. 1 кандидатът посочва уникалния цифров регистрационен номер на оператора на БЛС и прилага документ за платена държавна такса, освен ако същата не е платена по електронен път.
...
2. (изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) в резервирано въздушно пространство, указано в Плана за използване на въздушното пространство, издаван съгласно Инструкция № 245 от 24 април 2024 г. за функциониране на Единната система за гражданско и военно управление на въздушното пространство на предтактическо и тактическо ниво (ДВ, бр. 41 от 2024 г.), което може да бъде:
...
(2) (Доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Експлоатация на БЛС в зоните по ал. 1 може да бъде разрешена по изключение, при условие че е представена оценка на експлоатационния риск и е получено разрешение за експлоатация в специфична категория по реда, определен в глава девета или глава десета от настоящата наредба, или след получаване на разрешението по чл. 56, ал. 6.
...
(5) (Доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Надзорът се осъществява посредством инспекции и проверки, предназначени да осигурят на ГД "ГВА" доказателства за съответствие на операторите на БЛС, лицата по чл. 15, ал. 2 и лицата по чл. 28а, ал. 1 с Регламент за изпълнение (ЕС) 2019/947, регламентите за неговото изменение и допълнение и на тази наредба.
...
**Чл. 62.** (1) (Изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Въз основа на информацията за проведените изпити, подадена от лицата по чл. 28а, и информацията по чл. 61, ал. 3 и 5 и като се отчита сложността на извършваните операции и нивото на риск, породен от тях, се провеждат планови инспекции на операторите на БЛС, лицата по чл. 15, ал. 2 и лицата по чл. 28а, ал. 1 по график, утвърден от главния директор на ГД "ГВА" или оправомощено от него длъжностно лице.

(2) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) За извършването на планова инспекция операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 се уведомява писмено от главния директор на ГД "ГВА" или от оправомощено от него длъжностно лице най-малко 7 работни дни предварително.
...
(5) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 не се уведомява предварително за провеждането на извънредна инспекция.
...
**Чл. 63.** (1) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Когато в хода на инспекцията се установи, че операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 са допуснали нарушение на приложимите изисквания и то е довело или би могло да доведе до риск за безопасността при експлоатацията с БЛС, председателят на комисията по чл. 62, ал. 6, т. 1, извършваща инспекцията, информира незабавно главния директор на ГД "ГВА" или оправомощеното от него длъжностно лице.

(2) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) След приключване на инспекцията комисията съставя доклад за резултатите от нея. Копие от доклада се връчва на оператора на БЛС, на лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1. Докладът заедно със събраните доказателства се прилага в делото на оператора на БЛС, на лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1, водено в ГД "ГВА".

(3) В случай на констатирани несъответствия, описани в доклада от инспекцията, комисията ги класифицира като:

1. (доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) констатации от ниво 1 - при установено значително несъответствие с приложимите изисквания по отношение на процедурите и ръководствата на организацията или с условията, при които е издадено LUС, разрешение за експлоатация в специфична категория, разрешение за експлоатация в рамките на клубове и сдружения за авиомоделизъм, одобрение по чл. 28а. ал. 1, или със съдържанието на приета декларация за експлоатация, декларация на субект и декларация за извършване на професионална дейност в неограничена категория, което води до намалена безопасност или сериозно застрашава безопасността на полетите, и включват, но не се ограничават до:

а) (изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) непредоставяне на достъп на компетентния орган до съоръжения, БЛС, документи, записи, данни, процедури или всякакви други материали, отнасящи се до дейността на оператора на БЛС, на лицето по чл. 15, ал. 2 или на лицето по чл. 28а, ал. 1, по време на нормалното работно време, след като ГД "ГВА" е уведомила писмено два пъти оператора на БЛС;

б) фалшифициране на представените документи и доказателства;

в) (доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) доказателства за злоупотреба или използване с цел измама на притежавано удостоверение за оператор на лека БЛС, разрешение за експлоатация в специфична категория, разрешение за експлоатация в рамките на клубове и сдружения за авиомоделизъм, одобрение по чл. 28а, ал. 1 или със съдържанието на приета декларация за експлоатация, декларация на субект и декларация за извършване на професионална дейност в неограничена категория;

г) липса на отговорен ръководител, когато е приложимо;

2. (доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) констатации от ниво 2 - при установено несъответствие с приложимите изисквания по отношение на процедурите и ръководствата на организацията или с условията, при които е издадено удостоверение за оператор на лека БЛС, разрешение за експлоатация в специфична категория, разрешение за експлоатация в рамките на клубове и сдружения за авиомоделизъм, одобрение по чл. 28а, ал. 1, или със съдържанието на приета декларация за експлоатация, декларация на субект и декларация за извършване на професионална дейност в неограничена категория, което може да доведе до намаляване на безопасност или сериозно да застраши безопасността на полетите.

(4) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 представят в ГД "ГВА" план за коригиращи действия заедно с анализ на причините за всяко несъответствие, както и срокове за отстраняването им в срок до 14 работни дни от получаване на доклада.

(5) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) В срок до 7 работни дни след получаване на документите по ал. 4 комисията анализира съдържанието им и информира оператора на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 за приемането или отхвърлянето на представения план за коригиращи действия.

(6) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Когато планът за коригиращи действия е приет, операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 представят доказателства в ГД "ГВА" за коригиране на несъответствията, като комисията ги оценява в срок до 7 работни дни и:

1. (изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) в случай че предоставените доказателства и материали са оценени като приемливи, несъответствието се счита за отстранено и операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 се уведомява писмено;

2. (изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) в случай че предоставените доказателства и материали са оценени като неприемливи, операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 се уведомява писмено за необходимостта от предоставяне на допълнителна информация, разяснения и доказателства за коригиране на несъответствието, като се посочва срок за това;

3. (изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) в случай че операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 не предостави изискуемата информация в определения срок или тя повторно е неприемлива, констатациите от ниво 2 се повишават в ниво 1, като операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 се уведомява писмено.
...
(2) (Изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Докладът по ал. 1 се изготвя в резултат от проведените инспекции над дейността на оператора на БЛС, на лицето по чл. 15, ал. 2 или на лицето по чл. 28а, ал. 1, в който се предлага правата на оператора на БЛС, на лицето по чл. 15, ал. 2 или на лицето по чл. 28а, ал. 1 да бъдат временно спрени, ограничени или отнети.
...
2. (изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 не може да изпълнява някои от дейностите, за които има права, в съответствие с тази наредба, Регламент (ЕС) 2018/1139, както и с регламентите за изпълнение и делегираните регламенти към него;
...
4. (изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 е заявило писмено желанието си временно да бъдат ограничени правата по приетата декларация или издаденото одобрение съответно.

(2) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Възобновяването на ограничени права по ал. 1 се извършва със заповед на главния директор на ГД "ГВА" или оправомощено от него длъжностно лице след представяне в ГД "ГВА" на доказателства от оператора на БЛС, от лицето по чл. 15, ал. 2 или от лицето по чл. 28а, ал. 1, че е в състояние да извършва безопасно и в съответствие с изискванията дейността, обект на ограничението, и след извършване на необходимите инспекции и представен доклад от председателя на комисията по чл. 62, ал. 6, т. 1, извършваща инспекцията, за положителен резултат.

(3) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) Главният директор на ГД "ГВА" или оправомощено от него длъжностно лице писмено уведомява оператора на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 за извършеното възобновяване на ограничените права.

(4) (Изм. и доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) В случай че операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 не предприеме коригиращи действия в срока, определен в заповедта по чл. 64, ал. 1, или резултатът от инспекциите по ал. 2 не потвърждава, че операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 е в състояние да извършва безопасно дейността си и в съответствие с изискванията, ограничените права не се възобновяват, за което операторът на БЛС, лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 се уведомява писмено.
...
4. (изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) лицето по чл. 15, ал. 2 или лицето по чл. 28а, ал. 1 е заявило да бъдат прекратени правата по приетата декларация или издаденото одобрение;

5. (доп. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) удостоверение за оператор на лека БЛС, разрешение за експлоатация в специфична категория, разрешение за експлоатация в рамките на клубове и сдружения за авиомоделизъм, одобрение по чл. 28а, ал. 1 са издадени или декларация за експлоатация и декларация за извършване на професионална дейност в неограничена категория са приети въз основа на неистински документи или на документи с невярно съдържание;

6. (изм. - ДВ, бр. 114 от 2025 г., в сила от 24.12.2025 г.) операторът на БЛС или лицето по чл. 28а, ал. 1 са обявени в несъстоятелност с влязло в сила съдебно решение или е започнала процедура по ликвидацията им.
...
## Заключителни разпоредби КЪМ НАРЕДБА ЗА ИЗМЕНЕНИЕ И ДОПЪЛНЕНИЕ НА НАРЕДБА № Н-6 ОТ 11.04.2023 Г. ЗА УСЛОВИЯТА И РЕДА ЗА ЕКСПЛОАТАЦИЯТА НА БЕЗПИЛОТНИ ЛЕТАТЕЛНИ СИСТЕМИ И НАДЗОРА НАД ТЕХНИТЕ ОПЕРАТОРИ

(ОБН. - ДВ, БР. 114 ОТ 2025 Г., В СИЛА ОТ 24.12.2025 Г.)

§ 20. Наредбата влиза в сила от деня на обнародването и в "Държавен вестник", с изключение на § 3, който влиза в сила 6 (шест) месеца след обнародването на наредбата в "Държавен вестник".
