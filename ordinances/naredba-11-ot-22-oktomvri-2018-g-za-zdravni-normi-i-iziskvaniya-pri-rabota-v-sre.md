...
(4) (Изм. - ДВ, бр. 40 от 2024 г.) Периодичното медицинско наблюдение на лицата, допускани до работа в ядрени централи, се извършва най-малко веднъж годишно и включва прегледи и изследвания, посочени в приложение № 3.

(4а) (Нова - ДВ, бр. 40 от 2024 г.) В ядрените централи, в които има създадено структурно звено по чл. 64, ал. 3, изречение второ от Закона за здравето, със заповед на ръководителя на ядрената централа се утвърждават вътрешни правила за организирането и провеждането на периодичното медицинско наблюдение.
...
X i- индивидуалният резултат на лицето по даден тест;

- емпирично установената средна стойност на нормативната извадка;

? - емпирично установеното стандартно отклонение на нормативната извадка.
