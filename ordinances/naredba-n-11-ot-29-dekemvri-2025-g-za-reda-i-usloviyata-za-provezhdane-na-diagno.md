...
а) имуносупресирани лица, включително тези, получаващи дългосрочно кортикостероиди (в доза, еквивалентна на преднизон >= 15 mg/ден за >= 1 месец), химиотерапия или инхибитори на тумор некротизиращия фактор - алфа (TNF-?);
