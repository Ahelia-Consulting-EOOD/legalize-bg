...
**Чл. 3.** (1) Кметът на общината, в съответствие с разпоредбите на Закона за опазване на околната среда (ЗООС), специалните закони в областта на околната среда планира, организира и контролира опазването на околната среда на територията на общината, като:
...
1. (отм. с Решение № 1008 по Протокол № 42 от 30.06.2022 г.)
...
5. (отм. с Решение № 1008 по Протокол № 42 от 30.06.2022 г.)
...
7. Внасянето в почвите на торове, компост и други подобрители, на биологично активни вещества и хранителни субстрати, които не отговарят на условията, определени в Закона за защита на растенията (Обн. ДВ, бр. 91 от 10.10.1997 г., изм. ДВ, бр. 96 от 28.11.2006 г., изм. ДВ. бр. 28 от 5 Април 2011 г.);
...
3. Унищожаване или вземане на яйца, включително в случаите, когато те са изоставени;
...
1. Да спазват режимите, установени по реда на Закона за Защитените Територии (ЗЗТ) със заповедта за обявяване на защитената територия и плана за управлението и;
...
5. Окосяват редовно незастроените терени, които стопанисват на територията на регулационните граници на гр. Велико Търново и останалите населените места на общината;

6. При възникване на замърсяване или опасност от замърсяване, са длъжни незабавно да информират кмета на общината, както и да предприемат незабавно действия за ограничаване на последиците от него върху здравето на хората и околната среда.
...
**Чл. 31.** (1) (Изм. с Решение № 1509 по Протокол № 59 от 27.06.2019 г.) Дейностите по събиране, временно съхраняване, транспортиране, разкомплектоване, оползотворяване и/или обезвреждане на отпадъците се извършват от лица, които отговарят на изискванията на чл. 35 от Закона за управление на отпадъците.
...
(3) Когато ПУСО не е част от процедурата за съгласуване и одобряване на инвестиционните проекти, в изпълнение на чл. 11, ал. 4, т. 2 от ЗУО, се одобрява от отдел "Околна среда".
...
**Чл. 48.** (Изм. с Решение № 1008 по Протокол № 42 от 30.06.2022 г.) Системата за разделно събиране на отпадъци от опаковки на територията на Община Велико Търново обхваща минимум следните населени места:
...
**Чл. 50.** (1) (Изм. с Решение № 1008 по Протокол № 42 от 30.06.2022 г.) Кметът на общината организира събирането и транспортирането на едрогабаритни отпадъци и тяхното последващо третиране.
...
2. (изм. с Решение № 1008 по Протокол № 42 от 30.06.2022 г.) Сключва договор с лице, което да осъществи тяхното събиране, транспортиране и предаване за третиране;
...
(3) В срока по ал. 2, собственикът има право да поиска връщане на ИУМПС, след като заплати на лицето по чл. 51, ал. 1 разходите във връзка с принудителното преместване и съхраняване на площадката.
...
**Чл. 55.** (1) Причинителите на опасни и производствени отпадъци организират сами и за своя сметка третирането и/или транспортирането им, съгласно изискването на ЗУО и Наредбата за третиране и транспортиране на опасни и производствени отпадъци (ДВ, бр. 29 от 1999 г.).
...
(3) (Изм. с Решение № 1008 по Протокол № 42 от 30.06.2022 г.) Биоотпадъците от поддръжката на паркове и градини общинска собственост се събират и се извозват своевременно до местата за третиране.
...
**Чл. 58.** (1) Събирането и транспортиране на биоотпадъци на територията на общината се извършва от лице, с което кметът на общината сключва договор по реда на Закона за обществените поръчки и което притежава съответните разрешителни съгласно ЗУО.
...
2. (Изм. с Решение № 1008 по Протокол № 42 от 30.06.2022 г.) Използването на озвучителни и музикални уредби извън закритите помещения след 23.00 часа, както и причиняването на шум, с който се нарушава обществения ред и спокойствието на гражданите.
...
(3) (Отм. с Решение № 1008 по Протокол № 42 от 30.06.2022 г.)

(4) (Отм. с Решение № 1008 по Протокол № 42 от 30.06.2022 г.)
...
**Чл. 83а.** (1) В кметствата на Община Велико Търново се води регистър на пчелините.
...
3. За извършване на регистрацията по т. 1 не се заплаща такса;

4. Собственикът заявява за вписване в регистъра промени в данните, подлежащи на регистрация, в 15-дневен срок от настъпването им.
...
**Чл. 91.** (Изм. с Решение № 937 по Протокол № 36 от 25.01.2018 г.) За констатирани нарушения на разпоредби на тази Наредба, виновните лица се наказват, както следва:
...
**Чл. 93.** (Изм. с Решение № 937 по Протокол № 36 от 25.01.2018 г.) В случаите на нарушение на тази Наредба, актовете за установяване на административно нарушение могат да се съставят от:
