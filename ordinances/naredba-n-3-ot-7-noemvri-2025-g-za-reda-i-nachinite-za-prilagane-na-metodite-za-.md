...
(3) Приема се, че поемането на икономически значим риск от страна по контролираната сделка, така както е обективирано в наличните писмени доказателства, съответства на действителното поведение на свързаните лица, когато страната, която поема риска, упражнява контрол върху риска и има финансовия капацитет да поеме риска.
...
1. свързано лице, което допринася за контрола върху икономически значим риск, без да поема този риск, получава подходяща компенсация за изпълнението на тази функция, съответстваща на неговия принос, която може да е под формата на споделяне на потенциалните финансови последствия, свързани с риска;
...
2. предоставяне на взаимносвързани нематериални блага (например предоставяне на права за производство на патентован продукт ведно с производствено ноу-хау, свързано със същия продукт);

3. сделки с допълващи се продукти (например предоставяне на нематериално благо ведно с услуги, квалифициран персонал, ключови компоненти или специализирано оборудване);
...
(5) За целите на ал. 4 се вземат предвид икономически значимите рискове в оценяваната сделка и характеристиките на статистическото разпределение на стойностите в редицата, като брой на стойностите, форма на разпределението и разсейване.
...
1. средната аритметична стойност на стойностите в редицата - в случаите по чл. 20, ал. 2;
...
(2) Надеждността на резултата от прилагането на метода на сравнимите неконтролирани цени се оценява съобразно степента на сходство между сравняваните сделки по отношение на:
...
**Чл. 24.** (1) Надеждността на резултата от прилагането на метода на препродажбената цена се оценява съобразно степента на сходство между:
...
(4) За целите на ал. 2 себестойността може да включва разходни елементи, които се прехвърлят без надбавка на купувача в контролираната сделка.
...
**Чл. 28.** (1) Надеждността на резултата от прилагането на метода на увеличената стойност се оценява съобразно:
...
**Чл. 34.** (1) Надеждността на резултата от прилагането на метода на транзакционната нетна печалба се оценява съобразно:
...
**Чл. 42.** (1) Анализ на остатъчната печалба се извършва, когато част от приноса към комбинирания резултат на поне една от страните по контролираната сделка може да бъде по-надеждно оценена чрез прилагането на друг метод за определяне на пазарните цени.
...
**Чл. 43.** Надеждността на резултата от прилагането на метода на разпределената транзакционна печалба се оценява съобразно:
...
а) не може да се установи каква част от услугата получава всяко лице, или
...
в) икономически значимите рискове, свързани с актива или дейността, за които се използва финансирането, и очакваната възвръщаемост от този актив или дейност;
...
7. съществуващи опционни клаузи, включително за конвертиране на дълга в друг финансов инструмент, за предсрочно погасяване или удължаване на срока за погасяване на финансово задължение, за промяна или отмяна на падежни дати за главница или лихва;
...
13. опционни клаузи в полза на кредитора или длъжника;
...
10. "Трудно за оценяване нематериално благо" е нематериално благо, включително права, за което към момента на неговото предоставяне или прехвърляне между свързани лица:
