...
**Чл. 1.** (1) С тази наредба се уреждат условията и редът за предоставяне на безвъзмездна финансова помощ за обновяване и развитие на селата, опазване и съхраняване на селското наследство и културни традиции по Специалната предприсъединителна програма на Европейския съюз (ЕС) за развитие на земеделието и селските райони в Република България (САПАРД).
...
**Чл. 5.** (1) Минималният размер на одобрените инвестиционни разходи за проект е левовата равностойност на 30 000 евро.

(2) Максималният размер на одобрените инвестиционни разходи за проект е левовата равностойност на 1 000 000 евро.
...
(2) Кандидатите по ал. 1 се подпомагат за проект, който:
...
7. (изм. - ДВ, бр. 19 от 2005 г., изм. и доп. - ДВ, бр. 104 от 2005 г.) услугите и доставките, обекти на инвестицията, са с произход от страните - членки на Европейския съюз, или от България, Румъния, Турция, Албания, Босна и Херцеговина, Хърватия, Сърбия и Черна гора и бивша Югославска република Македония.
...
6. банкови такси, такси по обезпечителни сделки, включително банкови гаранции и разходи, свързани с обслужване на банкови сметки;
...
12. изграждане или подобряване на отклонения на водоснабдителната или уличната мрежа, собственост на частни лица;

13. изграждане или подобряване на канализационна мрежа, собственост на частни лица;

14. разходи, направени преди датата на предоставяне правото на управление на средствата по мярката от страна на Европейската комисия.

### Глава трета. РЕД ЗА ПРЕДОСТАВЯНЕ НА ФИНАНСОВА ПОМОЩ

**Чл. 10.** (1) Кандидатите за финансово подпомагане подават в Централно управление (ЦУ) на Държавен фонд "Земеделие" (ДФ "Земеделие"), изпълняващ функциите на Агенция "САПАРД", молба по образец, утвърден от изпълнителния директор на фонда, към която прилагат документите по приложения № 3 и 4.
...
(2) При неизпълнение на предходната алинея разходите за подготовка на работния проект не се подпомагат.

(3) (Изм. - ДВ, бр. 104 от 2005 г., изм. - ДВ, бр. 36 от 2007 г., в сила от 01.01.2007 г.) След изготвянето на работен проект в изпълнение на ал. 1 кандидатът провежда процедура за възлагане на обществена поръчка за изработването на инвестиционния проект в съответствие със Закона за обществените поръчки и свързаните с него подзаконови нормативни актове.
...
**Чл. 15.** (1) (Изм. - ДВ, бр. 104 от 2005 г., изм. - ДВ, бр. 36 от 2007 г., в сила от 01.01.2007 г.) В случаите, когато кандидатът е сключил договор и представил "работен проект" по глава седма от Наредба № 4 от 2001 г. за обхвата и съдържанието на инвестиционните проекти (ДВ, бр. 51 от 2001 г.) и са изпълнени изискванията на чл. 14, се провежда процедура за възлагане на изпълнението на инвестиционния проект в съответствие със Закона за обществените поръчки и свързаните с него подзаконови нормативни актове.

(2) При неизпълнение на предходната алинея договорът по чл. 13 се прекратява.
...
(2) Плащането на част от инвестицията се извършва само ако е посочено в инвестиционния проект, размерът на инвестицията надхвърля левовата равностойност на 300 000 евро и е одобрено от изпълнителния директор на Държавен фонд "Земеделие".

(3) Допустими са две междинни плащания по предходната алинея.
...
(3) Държавен фонд "Земеделие" може да изиска представянето и на други документи, извън посочените в приложение № 6, които са предвидени в договора за предоставяне на финансова помощ.

(4) В случаите, когато в документите по ал. 2 и 3 има непълноти или неточности, ДФ "Земеделие" уведомява писмено кандидата, който в срок, определен от ЦУ на ДФ "Земеделие", течащ от датата на уведомяването, може да отстрани констатираните непълноти или неточности чрез представяне на допълнителни и/или нови документи.

**Чл. 19.** (1) Държавен фонд "Земеделие" изплаща финансовата помощ по проекта в срок три месеца от постъпване на заявката за плащане заедно с всички необходими документи, доказващи направената инвестиция.
...
1. Изграждане или подобряване на водоснабдителната мрежа.

2. Подобряване на уличната мрежа.

3. Изграждане или подобряване на канализационната мрежа.

4. Възстановяване на исторически сгради - публична общинска собственост.

5. Изграждане или възстановяване на многофункционални културно-информационни центрове и паркове - публична общинска собственост.

6. Изграждане или подобряване на места за събиране на селскостопански, битови отпадъци, включително трупосъбирателни площадки.
...
2. "Идеен проект" по глава пета или "работен проект" по глава седма от Наредба № 4 от 2001 г. за обхвата и съдържанието на инвестиционните проекти (стандартна форма).
...
8. Копие от положително решение за оценка на въздействието на проекта върху околната среда, издадено от Министерството на околната среда и водите, съответно от регионалната инспекция по околната среда и водите, при спазване на изискванията на Закона за опазване на околната среда.
...
15. (предишна т. 16 - ДВ, бр. 19 от 2005 г.) Тръжно досие съгласно Правилата за провеждане на тръжни процедури в съответствие с Многогодишното финансово споразумение.

16. (предишна т. 17 - ДВ, бр. 19 от 2005 г.) Решение на Комисията за земеделски земи/комисии към областните дирекции по земеделие и гори за промяна в предназначението на земеделски земи съгласно Закона за опазване на земеделските земи в случаите, когато това се налага.

17. (предишна т. 18 - ДВ, бр. 19 от 2005 г.) Могат да бъдат представени и:

17.1. документ(и), доказващ(и) участието на местните хора във вземането на решения за проекта (одобрение от местни НПО);

17.2. документ(и), доказващ(и), че в общината са започнати проекти по други програми за развитие.

Приложение № 4 към чл. 10, ал. 1

Специфични документи

1. За дейност "Изграждане или подобряване на водоснабдителната мрежа, подобряване на уличната мрежа":

съгласувателно писмо за ползване на водоизточник на етап предпроектиране в случай на ново строителство или увеличаване на капацитета при реконструкция, издадено от собственика на водоизточника.

2. За дейност "Изграждане или подобряване на канализационната мрежа":

съгласувателно писмо за ползване на канал на етап предпроектиране в случай на ново строителство или увеличаване на капацитета при реконструкция.

3. За дейност "Възстановяване на исторически сгради - публична общинска собственост":

копие от удостоверение, издадено от Националния институт за паметници на културата, че сградата е включена в списъка на "паметниците на материалната култура", или становище на общинския съвет, определящо назованата в проекта сграда като историческа или като паметник на културата;

б) акт за публична общинска собственост за сградата и земята под нея към датата на кандидатстване.

4. За дейност "Изграждане или възстановяване на многофункционални културно-информационни центрове и паркове - публична общинска собственост":

акт за публична общинска собственост за сградата и земята под нея към датата на кандидатстване или акт за собственост на земята при изграждане на парк.

5. За дейност "Изграждане или подобряване на места за събиране на селскостопански, битови отпадъци, включително трупосъбирателни площадки":

а) акт за публична общинска собственост за земята, върху която ще се изграждат или подобряват съоръженията;

б) решение за определяне на терена за изграждане на трупосъбирателна площадка съгласно изискванията на чл. 8 от Наредба № 29 от 2002 г. на МЗГ, в случай че се кандидатства за изграждане на нова трупосъбирателна площадка.
...
5. Проектно-сметна документация според чл. 24, ал. 2 от Наредба № 4 от 2001 г. за обхвата и съдържанието на инвестиционните проекти, Закон за устройство на територията.

6. Разрешително за ползване на строеж, издадено от Дирекцията за национален строителен контрол - протокол образец 16.
...
9. (изм. - ДВ, бр. 36 от 2007 г., в сила от 04.05.2007 г.) Фактура, платежни нареждания и банкови извлечения от деня на извършване на плащането, доказващи плащане от страна на ползвателя.

10. Сертификати за произход на всички елементи на предмета на инвестицията (съдържащи конкретни характеристики на стоките, като търговска марка, модел, сериен номер, количество и т.н.).
...
13. Сертификати за качество на машини и съоръжения.

14. Сертификат за 72-часова проба на машините (за I 01 и I 02).

15. Застрахователна полица на предмета на инвестицията в полза на ДФ "Земеделие", покриваща рисковете, описани в договора между кандидата и ДФЗ.

16. Касова бележка/платежно нареждане и пълно банково извлечение за платена застрахователна премия.

17. Банкова гаранция за добро изпълнение в полза на ДФ "Земеделие" в случай на междинно плащане.
