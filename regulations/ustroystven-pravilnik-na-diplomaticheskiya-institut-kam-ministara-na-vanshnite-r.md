...
(2) При класиране на документите се извършва проверка за наличието на всички материали, посочени в тях, като се образува служебна преписка, която се разпределя и съхранява според адресата или съдържанието и.
