---
titulo: ЗАКОН ЗА КРЕДИТИТЕ ЗА НЕДВИЖИМИ ИМОТИ НА ПОТРЕБИТЕЛИ
identificador: '2136890030'
pais: bg
rango: закон
...
effective_date: null
category: laws
eli: /eli/bg/закон/2016/7/29/zakon-za-kreditite-za-nedvizhimi-imoti-na-potrebiteli/con
amendment_history:
- dv: 59/2016
  date: '2016-07-29'
- dv: 97/2016
...
(Когато е приложимо) Обменният курс, използван за превалутирането на погасителните Ви вноски от (валутата на кредита) в (националната валута на потребителя), ще бъде

курсът, публикуван от БНБ на (дата) или ще бъде изчислен на (дата) чрез използване на (посочете наименованието на показателя или начина за изчисляване).
