---
titulo: ЗАКОН ЗА АВТОМОБИЛНИТЕ ПРЕВОЗИ
identificador: '2134681088'
pais: bg
rango: закон
...
category: laws
eli: /eli/bg/закон/1999/9/17/zakon-za-avtomobilnite-prevozi/con
amendment_history:
- dv: 82/1999
  date: '1999-09-17'
- dv: 11/2002
...
## Допълнителни разпоредби КЪМ ЗАКОНА ЗА ИЗМЕНЕНИЕ И ДОПЪЛНЕНИЕ НА ЗАКОНА ЗА АВТОМОБИЛНИТЕ ПРЕВОЗИ
...
## Заключителни разпоредби КЪМ ЗАКОНА ЗА ИЗМЕНЕНИЕ И ДОПЪЛНЕНИЕ ЗАКОНА ЗА АВТОМОБИЛНИТЕ ПРЕВОЗИ
...
## Заключителни разпоредби КЪМ ЗАКОН ЗА ИЗМЕНЕНИЕ И ДОПЪЛНЕНИЕ НА ЗАКОНА ЗА ЕКСПОРТНИЯ КОНТРОЛ НА ПРОДУКТИ, СВЪРЗАНИ С ОТБРАНАТА, И НА ИЗДЕЛИЯ И ТЕХНОЛОГИИ С ДВОЙНА УПОТРЕБА Заключителни разпоредби КЪМ
