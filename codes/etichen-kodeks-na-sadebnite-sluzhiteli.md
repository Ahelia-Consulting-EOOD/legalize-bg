...
**§ 5.** Етичният кодекс е одобрен от Висш съдебен съвет с решение по протокол № 22/27.05.2009 г. на основание чл. 30, ал. 1, т. 12 от Закона за съдебната власт.

**§ 6.** За неуредените в този кодекс случаи се прилагат съответно разпоредбите на Закона за финансово управление и контрол в публичния сектор, Закона за предотвратяване и разкриване на конфликт на интересите и Кодекса на труда.
