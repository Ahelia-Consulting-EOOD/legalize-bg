...
a) да отговаря точно и конструктивно на запитванията от страна на етичната комисия във връзка с всякакви изявления и оплаквания, отправени от клиенти; отказът да го направи може да се приеме сам по себе си като лошо професионално поведение;
...
6. Ветеринарните лекари, които съзнателно или поради небрежност позволяват незаконна практика в техните лечебни заведения, подлежат на санкции за непрофесионално поведение.

В рамките на работното време присъствието на ветеринарен лекар е задължително.
